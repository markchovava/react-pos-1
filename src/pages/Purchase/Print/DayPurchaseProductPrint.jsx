...
const DayPurchaseProductPrint = React.forwardRef((props,  ref) => { 

    const purchases = props.purchase
        ...
        <section className='px-[2rem] py-[2.5rem]'>
            <div className='flex items-center justify-between mb-4'>
                ...
                <div className='text-md font-semibold'>
                    ...
                    <div className='pb-0 mb-0'> Count: {purchases.results?.length} </div>
                </div>
            </div>
...
export default DayPurchaseProductPrint