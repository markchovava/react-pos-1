         ...
         <section className='w-[90vw] h-[100vh] left-[10vw] bg-slate-100 fixed'>
            <section className='w-[89vw] h-[32vh] fixed border-b border-black '>
               ...
               <div className='w-full h-[10vh] bg-white flex items-center justify-center shadow-lg pr-[0.5rem]'>
                  <div className='w-[96%] flex justify-between items-center'>
                     <div className=''>
                        <h1 className='font-bold text-xl'> Monthly Sales Order Page </h1>
                     </div>
                     <div className=''>
               ...
               <div className='w-full h-[7vh] bg-white flex items-end justify-center pr-[0.5rem]'>
                  ...
                  <div className='w-[96%] bg-white text-slate-800 border border-slate-300 py-2 flex justify-center items-center'>
                     ...
                     <div className='w-[25%] border-r border-slate-300 font-semibold px-3'>USD </div>
                     <div className='w-[25%] border-r border-slate-300 font-semibold px-3'>ZWL</div>
                  </div>
               </div>
            </section>
            <section className='w-[89vw] h-[68vh] top-[32vh] text-black fixed overflow-y-auto scroll__width pb-8'>
               ...
               <div className='w-full bg-white flex flex-col items-center justify-center text-md'>
                  {/* Table Row */}
                  <div className='w-[96%] bg-white text-slate-800 border border-slate-300 py-2 flex justify-center items-center'>
                     <div className='w-[25%] border-r border-slate-300 px-3'>May 2023 </div>
                     <div className='w-[25%] border-r border-slate-300 px-3'>100 </div>
                     <div className='w-[25%] border-r border-slate-300 px-3'>$200.00 </div>
                     <div className='w-[25%] border-r border-slate-300 px-3'>$2 000.00</div>
                  </div>   
                  {/* Table Row */}
                  <div className='w-[96%] bg-white text-slate-800 border border-slate-300 py-2 flex justify-center items-center'>
                     <div className='w-[25%] border-r border-slate-300 px-3'>April 2023 </div>
                     <div className='w-[25%] border-r border-slate-300 px-3'>100 </div>
                     <div className='w-[25%] border-r border-slate-300 px-3'>$200.00 </div>
                     <div className='w-[25%] border-r border-slate-300 px-3'>$2 000.00</div>
                  </div>   
                  {/* Table Row */}
                  <div className='w-[96%] bg-white text-slate-800 border border-slate-300 py-2 flex justify-center items-center'>
                     <div className='w-[25%] border-r border-slate-300 px-3'>March 2023 </div>
                     <div className='w-[25%] border-r border-slate-300 px-3'>100 </div>
                     <div className='w-[25%] border-r border-slate-300 px-3'>$200.00 </div>
                     <div className='w-[25%] border-r border-slate-300 px-3'>$2 000.00</div>
                  </div>   
