...
const ListStockPrint = React.forwardRef((props,  ref) => { 
    ...
    <div ref={ref}>
      <section className='px-[2rem] py-[2.5rem]'>
        <div className='flex items-center justify-between mb-4'>
            <h2 className='text-3xl font-bold'>Stock Report</h2>
        ...
        <div className='w-full flex justify-start border border-slate-300 py-2'>
            ...
            <div className='w-[30%] border-r border-slate-300 font-semibold px-3'>STOCK </div>
            <div className='w-[30%] border-r border-slate-300 font-semibold px-3'>STOCK PRICE </div>
        </div>
        ...
        { products?.results &&
            ...
            <div key={i} className='w-full flex justify-start border border-slate-300 py-1'>
                ...
                <div className='w-[30%] border-r border-slate-300 px-3'> {item.quantity} </div>
                <div className='w-[30%] border-r border-slate-300 px-3'> ${((item.unit_price / 100) * item.quantity).toFixed(2)} </div>
            </div>
            )
        )}
